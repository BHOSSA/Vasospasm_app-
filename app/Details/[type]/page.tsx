            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="text-center">
                     <h4 className="text-xl font-bold text-gray-900">Vasospasm cases in the Uk north east in 2023</h4>
        </div>
                    ...
                    <div className="flex items-start">
                       ...
                       />  
                        <div className="ml-4">
                            ...
                            <p className="mt-1.5 text-lg font-medium leading-tight text-gray-500">in 2023</p>
                        </div>
                    </div>
                </div>
            </div>
